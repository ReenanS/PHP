...
CREATE TABLE IF NOT EXISTS `NaN`.`course` (
  ...
  INDEX `fk_curso_professor1_idx` (`teacher` ASC),
...
CREATE TABLE IF NOT EXISTS `NaN`.`schoolsubject` (
  ...
  INDEX `fk_disciplina_curso1_idx` (`course` ASC),
...
CREATE TABLE IF NOT EXISTS `NaN`.`teaches` (
  ...
  INDEX `fk_leciona_disciplina1_idx` (`schoolsubject` ASC),
...
CREATE TABLE IF NOT EXISTS `NaN`.`registration` (
  ...
  INDEX `fk_matriculado_disciplina1_idx` (`schoolsubject` ASC),
...
CREATE TABLE IF NOT EXISTS `NaN`.`notification` (
  ...
  INDEX `fk_notificacao_mensagem1_idx` (`notification` ASC),
...
CREATE TABLE IF NOT EXISTS `NaN`.`prerequisite` (
  ...
  INDEX `fk_pre_requisito_disciplina1_idx` (`schoolsubject` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NaN`.`learning` ;

CREATE TABLE IF NOT EXISTS `NaN`.`learning` (
  `student` INT NOT NULL,
  `knowledge` INT NOT NULL,
  `level` INT NULL,
  PRIMARY KEY (`student`, `knowledge`),
  INDEX `fk_aprendizado_conhecimento1_idx` (`knowledge` ASC),
...
CREATE TABLE IF NOT EXISTS `NaN`.`grade` (
  ...
  INDEX `fk_nota_matricula1_idx` (`registration` ASC, `student` ASC, `schoolsubject` ASC),
  INDEX `fk_nota_detalhe1_idx` (`detail` ASC),
